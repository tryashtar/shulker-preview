...
summon item ~ ~ ~ {UUID:[I;1936225644,1801810464,1886545270,1768257343],Item:{id:"tnt",Count:1b}}
...
execute if score #amount shulker_preview matches 1.. as 7368756c-6b65-7220-7072-65766965773f if data entity @s Item.tag.display.Name run loot replace block ~ 1 ~ container.1 loot tryashtar.shulker_preview:vanilla/first_row/named
execute if score #amount shulker_preview matches 1.. as 7368756c-6b65-7220-7072-65766965773f unless data entity @s Item.tag.display.Name run loot replace block ~ 1 ~ container.1 loot tryashtar.shulker_preview:vanilla/first_row/unnamed
execute if score #amount shulker_preview matches ..0 as 7368756c-6b65-7220-7072-65766965773f run loot replace block ~ 1 ~ container.1 loot tryashtar.shulker_preview:vanilla/first_row/empty
...
execute if score #amount shulker_preview matches 1.. as 7368756c-6b65-7220-7072-65766965773f if data entity @s Item.tag.display.Name run loot replace block ~ 1 ~ container.1 loot tryashtar.shulker_preview:vanilla/other_rows/named
execute if score #amount shulker_preview matches 1.. as 7368756c-6b65-7220-7072-65766965773f unless data entity @s Item.tag.display.Name run loot replace block ~ 1 ~ container.1 loot tryashtar.shulker_preview:vanilla/other_rows/unnamed
execute if score #amount shulker_preview matches ..0 as 7368756c-6b65-7220-7072-65766965773f run loot replace block ~ 1 ~ container.1 loot tryashtar.shulker_preview:vanilla/other_rows/empty
data modify block ~ 1 ~ Items[0].tag.display.Lore append from block ~ 1 ~ Items[1].tag.display.Lore[]
...
execute if score #more shulker_preview matches 1.. as 7368756c-6b65-7220-7072-65766965773f run loot replace block ~ 1 ~ container.1 loot tryashtar.shulker_preview:vanilla/other_rows/more
execute unless score #more shulker_preview matches 1.. as 7368756c-6b65-7220-7072-65766965773f run loot replace block ~ 1 ~ container.1 loot tryashtar.shulker_preview:vanilla/other_rows/empty
data modify block ~ 1 ~ Items[0].tag.display.Lore append from block ~ 1 ~ Items[1].tag.display.Lore[]
