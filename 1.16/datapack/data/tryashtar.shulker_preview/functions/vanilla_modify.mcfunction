...
execute if score #amount shulker_preview matches 1.. as 0-1c9-c369-0-2668 if data entity @s Item.tag.display.Name run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:vanilla/first_row/named
execute if score #amount shulker_preview matches 1.. as 0-1c9-c369-0-2668 unless data entity @s Item.tag.display.Name run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:vanilla/first_row/unnamed
execute if score #amount shulker_preview matches ..0 as 0-1c9-c369-0-2668 run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:vanilla/first_row/empty
...
execute if score #amount shulker_preview matches 1.. as 0-1c9-c369-0-2668 if data entity @s Item.tag.display.Name run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:vanilla/other_rows/named
execute if score #amount shulker_preview matches 1.. as 0-1c9-c369-0-2668 unless data entity @s Item.tag.display.Name run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:vanilla/other_rows/unnamed
execute if score #amount shulker_preview matches ..0 as 0-1c9-c369-0-2668 run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:vanilla/other_rows/empty
...
execute if score #total shulker_preview matches 1.. as 0-1c9-c369-0-2668 run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:vanilla/other_rows/more
execute unless score #total shulker_preview matches 1.. as 0-1c9-c369-0-2668 run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:vanilla/other_rows/empty
