...
execute if score #amount shulker_preview matches 1.. if data entity 0-1c9-c369-0-2668 Item.tag.display.Name run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:modded/first_row/named
execute if score #amount shulker_preview matches 1.. unless data entity 0-1c9-c369-0-2668 Item.tag.display.Name run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:modded/first_row/unnamed
execute if score #amount shulker_preview matches ..0 run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:modded/first_row/empty
...
execute if score #amount shulker_preview matches 1.. if data entity 0-1c9-c369-0-2668 Item.tag.display.Name run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:modded/other_rows/named
execute if score #amount shulker_preview matches 1.. unless data entity 0-1c9-c369-0-2668 Item.tag.display.Name run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:modded/other_rows/unnamed
execute if score #amount shulker_preview matches ..0 run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:modded/other_rows/empty
...
execute if score #total shulker_preview matches 1.. run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:modded/other_rows/more
execute unless score #total shulker_preview matches 1.. run loot spawn ~ ~ ~ loot tryashtar.shulker_preview:modded/other_rows/empty
