...
execute unless score #setup shulker_preview matches 1 if blocks 29999976 0 9832 29999976 0 9832 29999976 0 9832 all run function tryashtar.shulker_preview:.meta/setup
