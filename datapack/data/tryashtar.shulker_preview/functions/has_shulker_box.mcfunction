...
execute if score #ready shulker_preview matches 1 if score #boxes shulker_preview > #processed shulker_preview if score #setup shulker_preview matches 1.. at 0-1c9-c369-0-2668 run function tryashtar.shulker_preview:check_shulker_box
