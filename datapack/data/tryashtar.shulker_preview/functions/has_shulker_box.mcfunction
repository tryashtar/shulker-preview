...
execute if score #ready shulker_preview matches 1 if score #boxes shulker_preview > #processed shulker_preview if score #setup shulker_preview matches 1 positioned 29999977 1 9832 run function tryashtar.shulker_preview:check_shulker_box
