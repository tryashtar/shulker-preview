...
data remove block ~ ~ ~ Items[{Slot:13b}].tag.display.Lore
data modify block ~ ~ ~ Items[{Slot:13b}].tag.display.Lore append from block ~3 ~ ~ Text1
data modify block ~ ~ ~ Items[{Slot:13b}].tag.display.Lore append value "\"\\uF82C\\uF82A\\uF827\""
data modify block ~ ~ ~ Items[{Slot:13b}].tag.display.Lore append value "\"\""
data modify block ~ ~ ~ Items[{Slot:13b}].tag.display.Lore append value "\"\""
data modify block ~ ~ ~ Items[{Slot:13b}].tag.display.Lore append value "\"\""
data modify block ~ ~ ~ Items[{Slot:13b}].tag.display.Lore append value "\"\""
