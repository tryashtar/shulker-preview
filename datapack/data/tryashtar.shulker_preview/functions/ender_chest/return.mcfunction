...
data modify storage tryashtar.shulker_preview:data items[1].Slot set value 0b
data modify block ~ 1 ~ Items[0] set from storage tryashtar.shulker_preview:data items[1]
