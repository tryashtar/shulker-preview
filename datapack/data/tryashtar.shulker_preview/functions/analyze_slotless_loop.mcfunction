...
execute if score #slots shulker_preview matches 16.. run scoreboard players set #slots shulker_preview 0
...
execute if data storage tryashtar:shulker_preview running_contents[0] positioned ~ ~1 ~ run function tryashtar.shulker_preview:analyze_slotless_loop
