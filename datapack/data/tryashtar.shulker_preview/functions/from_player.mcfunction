...
execute if score #header_type shulker_preview matches 0..1 if data storage tryashtar.shulker_preview:data contents[0] run function tryashtar.shulker_preview:shulker_box/append_lore
execute if score #header_type shulker_preview matches 2 if data storage tryashtar.shulker_preview:data contents[0] run function tryashtar.shulker_preview:bundle/append_lore
