...
execute store result score #amount shulker_preview run data get storage tryashtar.shulker_preview:data contents
...
data modify storage tryashtar.shulker_preview:data running_contents set from storage tryashtar.shulker_preview:data contents
