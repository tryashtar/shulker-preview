...
execute if score #row_count shulker_preview matches 1.. run data modify storage tryashtar.shulker_preview:data items[0].tag.display.Lore append from block ~2 1 ~ Text2
