...
data modify storage tryashtar.shulker_preview:data items append from entity @s Inventory[{id:"minecraft:bundle"}]
...
execute store result score #slot shulker_preview store success score #bundles shulker_preview run data get storage tryashtar.shulker_preview:data items[0].Slot
