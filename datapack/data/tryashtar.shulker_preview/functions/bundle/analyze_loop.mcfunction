data modify storage tryashtar.shulker_preview:data item set from storage tryashtar.shulker_preview:data running_contents[0]
...
data remove storage tryashtar.shulker_preview:data running_contents[0]
...
execute if data storage tryashtar.shulker_preview:data running_contents[0] positioned ~ ~2 ~ run function tryashtar.shulker_preview:bundle/analyze_loop
