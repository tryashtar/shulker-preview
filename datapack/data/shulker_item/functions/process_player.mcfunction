...
execute if data block ~ ~ ~ Items[{Slot:12b,tag:{BlockEntityTag:{Items:[{}]}}}] unless data block ~ ~ ~ Items[{Slot:12b,tag:{shulker_processed:1b}}] run function shulker_item:process_box/12
execute if data block ~ ~ ~ Items[{Slot:13b,tag:{BlockEntityTag:{Items:[{}]}}}] unless data block ~ ~ ~ Items[{Slot:13b,tag:{shulker_processed:1b}}] run function shulker_item:process_box/13
execute if data block ~ ~ ~ Items[{Slot:14b,tag:{BlockEntityTag:{Items:[{}]}}}] unless data block ~ ~ ~ Items[{Slot:14b,tag:{shulker_processed:1b}}] run function shulker_item:process_box/14
execute if data block ~ ~ ~ Items[{Slot:15b,tag:{BlockEntityTag:{Items:[{}]}}}] unless data block ~ ~ ~ Items[{Slot:15b,tag:{shulker_processed:1b}}] run function shulker_item:process_box/15
execute if data block ~ ~ ~ Items[{Slot:16b,tag:{BlockEntityTag:{Items:[{}]}}}] unless data block ~ ~ ~ Items[{Slot:16b,tag:{shulker_processed:1b}}] run function shulker_item:process_box/16
execute if data block ~ ~ ~ Items[{Slot:17b,tag:{BlockEntityTag:{Items:[{}]}}}] unless data block ~ ~ ~ Items[{Slot:17b,tag:{shulker_processed:1b}}] run function shulker_item:process_box/17
execute if data block ~ ~ ~ Items[{Slot:18b,tag:{BlockEntityTag:{Items:[{}]}}}] unless data block ~ ~ ~ Items[{Slot:18b,tag:{shulker_processed:1b}}] run function shulker_item:process_box/18
execute if data block ~ ~ ~ Items[{Slot:19b,tag:{BlockEntityTag:{Items:[{}]}}}] unless data block ~ ~ ~ Items[{Slot:19b,tag:{shulker_processed:1b}}] run function shulker_item:process_box/19
execute if data block ~ ~ ~ Items[{Slot:20b,tag:{BlockEntityTag:{Items:[{}]}}}] unless data block ~ ~ ~ Items[{Slot:20b,tag:{shulker_processed:1b}}] run function shulker_item:process_box/20
execute if data block ~ ~ ~ Items[{Slot:21b,tag:{BlockEntityTag:{Items:[{}]}}}] unless data block ~ ~ ~ Items[{Slot:21b,tag:{shulker_processed:1b}}] run function shulker_item:process_box/21
execute if data block ~ ~ ~ Items[{Slot:22b,tag:{BlockEntityTag:{Items:[{}]}}}] unless data block ~ ~ ~ Items[{Slot:22b,tag:{shulker_processed:1b}}] run function shulker_item:process_box/22
execute if data block ~ ~ ~ Items[{Slot:23b,tag:{BlockEntityTag:{Items:[{}]}}}] unless data block ~ ~ ~ Items[{Slot:23b,tag:{shulker_processed:1b}}] run function shulker_item:process_box/23
