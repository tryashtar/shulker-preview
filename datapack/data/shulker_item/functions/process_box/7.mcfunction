...
data remove block ~ ~ ~ Items[{Slot:7b}].tag.display.Lore
data modify block ~ ~ ~ Items[{Slot:7b}].tag.display.Lore append from block ~3 ~ ~ Text1
data modify block ~ ~ ~ Items[{Slot:7b}].tag.display.Lore append value "\"                                         \""
