...
data remove storage tryashtar.shulker_preview:data items[0].Slot

data remove storage tryashtar.shulker_preview:data items[0].tag.HideFlags
data remove storage tryashtar.shulker_preview:data items[0].tag.display.Lore[-1]
data remove storage tryashtar.shulker_preview:data items[0].tag.display.Lore[-1]
data remove storage tryashtar.shulker_preview:data items[0].tag.display.Lore[-1]
data remove storage tryashtar.shulker_preview:data items[0].tag.display.Lore[-1]
data remove storage tryashtar.shulker_preview:data items[0].tag.display.Lore[-1]
...
data modify block ~ 1 ~ Items append from storage tryashtar.shulker_preview:data items[0]
