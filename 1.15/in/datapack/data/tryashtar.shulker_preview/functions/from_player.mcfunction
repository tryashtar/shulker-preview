...
data modify block ~ 1 ~ Items[0].tag.display.Lore append from storage tryashtar.shulker_preview:data line1
data modify block ~ 1 ~ Items[0].tag.display.Lore append from storage tryashtar.shulker_preview:data line2
data modify block ~ 1 ~ Items[0].tag.display.Lore append from storage tryashtar.shulker_preview:data line3
data modify block ~ 1 ~ Items[0].tag.display.Lore append from storage tryashtar.shulker_preview:data line4
data modify block ~ 1 ~ Items[0].tag.display.Lore append from storage tryashtar.shulker_preview:data line5
...
execute if score #modded shulker_preview matches 2 store result block ~ 1 ~ Items[0].tag.shulker_length int 1 run data get storage tryashtar.shulker_preview:data line1
