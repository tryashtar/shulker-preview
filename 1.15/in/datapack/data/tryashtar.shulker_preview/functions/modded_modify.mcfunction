...
execute if score #amount shulker_preview matches ..0 run data modify block ~2 1 ~ Text1 set value '{"translate":"%1$s%418634357$s","with":["",["\\uF800",{"nbt":"CustomName","interpret":true,"entity":"@e[type=area_effect_cloud,tag=tryashtar.shulker_preview,x=0,y=0,z=0,sort=nearest]","color":"white","italic":false}]]}'
data modify storage tryashtar.shulker_preview:data line1 set from block ~2 1 ~ Text1
...
data modify storage tryashtar.shulker_preview:data line2 set from block ~2 1 ~ Text2
...
data modify storage tryashtar.shulker_preview:data line3 set from block ~2 1 ~ Text3
...
data modify storage tryashtar.shulker_preview:data line4 set from block ~2 1 ~ Text4
...
data modify storage tryashtar.shulker_preview:data line5 set from block ~3 1 ~ Text1
...
data modify storage tryashtar.shulker_preview:data line6 set from block ~3 1 ~ Text2
