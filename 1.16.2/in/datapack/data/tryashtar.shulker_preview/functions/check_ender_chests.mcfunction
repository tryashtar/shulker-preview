...
data modify storage tryashtar.shulker_preview:data ender_chests set value []
data modify storage tryashtar.shulker_preview:data ender_chests append from entity @s Inventory[{id:"minecraft:ender_chest"}] 
data modify block ~ 1 ~ Items[0].tag.shulker_items set from storage tryashtar.shulker_preview:data ender_chests
...
execute store result score #slot shulker_preview store success score #success shulker_preview run data get storage tryashtar.shulker_preview:data ender_chests[0].Slot
