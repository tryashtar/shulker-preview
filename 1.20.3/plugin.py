...
def main(ctx: beet.Context):
   ...
   mcitems['recovery_compass'] = vanilla.assets.textures['minecraft:item/recovery_compass_16'].image.convert('RGBA')
   ...
   for entry in blocknames:
      ...
      if 'banner' in entry:
         ...
         ctx.assets.models[f'minecraft:item/{entry}'] = beet.Model(model)
      if entry == 'decorated_pot':
         pot = model_resolver.item_model.special.SpecialModelDecoratedPot(type='decorated_pot')
         display = vanilla.assets.models['minecraft:item/decorated_pot'].data
         model = pot.get_model(None, None)
         model['display'] = display['display']
         ctx.assets.models[f'minecraft:item/{entry}'] = beet.Model(model)
      if '_bed' in entry:
   ...
   ctx.assets.textures['minecraft:block/grass_block_top'] = beet.Texture(colorize(vanilla.assets.textures['minecraft:block/grass_block_top'].image.convert('RGBA'), rgba(0x7bbd6b)))
   ...
   for entry in blocknames:
      ...
      color = {"acacia_leaves":0x48b518,"birch_leaves":0x80a755,"dark_oak_leaves":0x48b518,"fern":0x7bbd6b,"jungle_leaves":0x48b518,"large_fern":0x7bbd6b,"lily_pad":0x71c35c,"oak_leaves":0x48b518,"short_grass":0x7bbd6b,"spruce_leaves":0x619961,"tall_grass":0x7bbd6b,"vine":0x48b518,"mangrove_leaves":0x92C648}.get(entry)
...
def get_items(ctx: beet.Context, release: beet.contrib.vanilla.Release):
   ...
   if not path.is_dir():
      ...
      subprocess.run(["java",'-DbundlerMainClass=net.minecraft.data.Main',"-jar",jar,"--reports",],
         cwd=path,
         check=True,
      )
...
currentchar='\u0900'
charmap={}
translations={"tryashtar.shulker_preview.translate":"%2$s","tryashtar.shulker_preview.empty_slot":get_spacing(18),"tryashtar.shulker_preview.row_end":get_spacing(-162)}
...
potion_dict={"night_vision":0xC2FF66,"long_night_vision":0xC2FF66,"invisibility":0xF6F6F6,"long_invisibility":0xF6F6F6,"leaping":0xFDFF84,"strong_leaping":0xFDFF84,"long_leaping":0xFDFF84,"fire_resistance":0xFF9900,"long_fire_resistance":0xFF9900,"swiftness":0x33EBFF,"strong_swiftness":0x33EBFF,"long_swiftness":0x33EBFF,"water_breathing":0x96D7BE,"long_water_breathing":0x96D7BE,"healing":16262179,"strong_healing":16262179,"harming":0xA9656A,"strong_harming":0xA9656A,"poison":0x87A363,"strong_poison":0x87A363,"long_poison":0x87A363,"regeneration":13458603,"strong_regeneration":13458603,"long_regeneration":13458603,"strength":0xFCC500,"strong_strength":0xFCC500,"long_strength":0xFCC500,"weakness":4738376,"long_weakness":4738376,"luck":3381504,"turtle_master":0x8D82E6,"strong_turtle_master":0x8D82E6,"long_turtle_master":0x8D82E6,"slow_falling":16773073,"long_slow_falling":16773073,"slowness":0x8BAFE0,"long_slowness":0x8BAFE0,"strong_slowness":0x8BAFE0,"water":3694022,"thick":3694022,"mundane":3694022,"awkward":3694022}
...
spawn_egg_colors={
   ...
   "sniffer_spawn_egg":(8855049,2468720),
   "camel_spawn_egg":(16565097,13341495),
   ...
   "polar_bear_spawn_egg": (0xeeeede, 14014157),
