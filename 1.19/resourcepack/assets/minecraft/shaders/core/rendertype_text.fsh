...
bool handleIntersection(vec2 intersection, vec2 flip, vec4 uvMinMax, vec3 normal, int rotation, out vec4 outCol) {
    if (0.0 <= intersection.x && intersection.x <= 1.0 && 0.0 <= intersection.y && intersection.y <= 1.0) {
        ...
        outCol.rgb *= dot(normal, vec3(102., 255., 166.)/255.);
        return outCol.a > 0.1;
    }
    return false;
}
...
**/
bool cuboid(int faces, vec3 rd, vec3 ro, vec3 from, vec3 to, vec4 uvX, int rotX, vec4 uvY, int rotY, vec4 uvZ, int rotZ, vec4 uvRange, out float t, out vec4 outCol) {
    from /= 16.0;
    to /= 16.0;
    vec3 size = to - from;
    // y
    float tY = (to.y - ro.y)/rd.y;
    if ((faces      & 1) == 1 && handleIntersection(((rd * tY + ro).xz - from.xz)/size.xz, vec2(0.0, 0.0), mapUV(uvY, uvRange), vec3(0.0, 1.0, 0.0), (rotY + 90) % 360, outCol)) {
        t = tY;
        return true;
    }
    // x
...
bool block_5(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    vec4 uvRange = getUV();
    float minT = 99999999.0;
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(0.0, 16.0, 0.0), vec3(16.0, 16.0, 16.0), vec4(0.0, 0.0, 16.0, 0.0), 0, vec4(0.0, 0.0, 16.0, 16.0), 0, vec4(0.0, 0.0, 16.0, 0.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_16(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(6.0, 0.0, 6.0), vec3(10.0, 1.0, 10.0), vec4(2.0, 6.0, 6.0, 7.0), 0, vec4(2.0, 2.0, 6.0, 6.0), 0, vec4(2.0, 6.0, 6.0, 7.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
    bool cube1 = cuboid(faces, rd, ro, vec3(7.0, 1.0, 7.0), vec3(9.0, 16.0, 9.0), vec4(0.0, 0.0, 2.0, 15.0), 0, vec4(2.0, 0.0, 4.0, 2.0), 0, vec4(0.0, 0.0, 2.0, 15.0), 0, uvRange, t, col);
    if (cube1 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_21(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(0.0, 0.0, 0.0), vec3(16.0, 15.0, 16.0), vec4(0.0, 1.0, 16.0, 16.0), 0, vec4(0.0, 0.0, 16.0, 16.0), 0, vec4(0.0, 1.0, 16.0, 16.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_23(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(0.0, 0.0, 0.0), vec3(16.0, 16.0, 16.0), vec4(0.0, 0.0, 16.0, 16.0), 0, vec4(0.0, 16.0, 16.0, 0.0), 0, vec4(0.0, 0.0, 16.0, 16.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_26(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(4.0, 0.0, 4.0), vec3(12.0, 16.0, 12.0), vec4(4.0, 0.0, 12.0, 16.0), 0, vec4(4.0, 4.0, 12.0, 12.0), 0, vec4(4.0, 0.0, 12.0, 16.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_27(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(6.0, 15.0, 6.0), vec3(10.0, 16.0, 10.0), vec4(6.0, 15.0, 10.0, 16.0), 0, vec4(6.0, 6.0, 10.0, 10.0), 0, vec4(6.0, 15.0, 10.0, 16.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
    bool cube1 = cuboid(faces, rd, ro, vec3(5.0, 14.0, 5.0), vec3(11.0, 15.0, 11.0), vec4(5.0, 14.0, 11.0, 15.0), 0, vec4(5.0, 5.0, 11.0, 11.0), 0, vec4(5.0, 14.0, 11.0, 15.0), 0, uvRange, t, col);
    if (cube1 && t < minT) {
        minT = t;
        outCol = col;
    }
    bool cube2 = cuboid(faces, rd, ro, vec3(5.0, 13.0, 5.0), vec3(11.0, 14.0, 11.0), vec4(4.0, 13.0, 12.0, 14.0), 0, vec4(4.0, 4.0, 12.0, 12.0), 0, vec4(4.0, 13.0, 12.0, 14.0), 0, uvRange, t, col);
    if (cube2 && t < minT) {
        minT = t;
        outCol = col;
    }
    bool cube3 = cuboid(faces, rd, ro, vec3(3.0, 11.0, 3.0), vec3(13.0, 13.0, 13.0), vec4(3.0, 11.0, 13.0, 13.0), 0, vec4(3.0, 3.0, 13.0, 13.0), 0, vec4(3.0, 11.0, 13.0, 13.0), 0, uvRange, t, col);
    if (cube3 && t < minT) {
        minT = t;
        outCol = col;
    }
    bool cube4 = cuboid(faces, rd, ro, vec3(2.0, 8.0, 2.0), vec3(14.0, 11.0, 14.0), vec4(2.0, 8.0, 14.0, 11.0), 0, vec4(2.0, 2.0, 14.0, 14.0), 0, vec4(2.0, 8.0, 14.0, 11.0), 0, uvRange, t, col);
    if (cube4 && t < minT) {
        minT = t;
        outCol = col;
    }
    bool cube5 = cuboid(faces, rd, ro, vec3(1.0, 3.0, 1.0), vec3(15.0, 8.0, 15.0), vec4(1.0, 3.0, 15.0, 8.0), 0, vec4(1.0, 1.0, 15.0, 15.0), 0, vec4(1.0, 3.0, 15.0, 8.0), 0, uvRange, t, col);
    if (cube5 && t < minT) {
        minT = t;
        outCol = col;
    }
    bool cube6 = cuboid(faces, rd, ro, vec3(2.0, 1.0, 2.0), vec3(14.0, 3.0, 14.0), vec4(2.0, 1.0, 14.0, 3.0), 0, vec4(2.0, 2.0, 14.0, 14.0), 0, vec4(2.0, 1.0, 14.0, 3.0), 0, uvRange, t, col);
    if (cube6 && t < minT) {
        minT = t;
        outCol = col;
    }
    bool cube7 = cuboid(faces, rd, ro, vec3(3.0, 0.0, 3.0), vec3(13.0, 1.0, 13.0), vec4(3.0, 0.0, 13.0, 1.0), 0, vec4(3.0, 3.0, 13.0, 13.0), 0, vec4(3.0, 0.0, 13.0, 1.0), 0, uvRange, t, col);
    if (cube7 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_34(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(0.0, 0.0, 0.0), vec3(16.0, 1.0, 16.0), vec4(0.0, 15.0, 16.0, 16.0), 0, vec4(0.0, 0.0, 16.0, 16.0), 0, vec4(0.0, 15.0, 16.0, 16.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_38(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(0.0, 15.99, 0.0), vec3(16.0, 16.0, 16.0), vec4(0.0, 0.0, 16.0, 0.009999999999999787), 0, vec4(0.0, 0.0, 16.0, 16.0), 0, vec4(0.0, 0.0, 16.0, 0.009999999999999787), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_41(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(3.0, 3.0, 3.0), vec3(13.0, 13.0, 13.0), vec4(3.0, 3.0, 13.0, 13.0), 0, vec4(3.0, 3.0, 13.0, 13.0), 0, vec4(3.0, 3.0, 13.0, 13.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_42(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(0.0, 0.0, 0.0), vec3(16.0, 9.0, 16.0), vec4(0.0, 7.0, 16.0, 16.0), 0, vec4(0.0, 0.0, 16.0, 16.0), 0, vec4(0.0, 7.0, 16.0, 16.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_44(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(0.0, 15.0, 0.0), vec3(16.0, 15.0, 16.0), vec4(0.0, 1.0, 16.0, 1.0), 0, vec4(0.0, 0.0, 16.0, 16.0), 0, vec4(0.0, 1.0, 16.0, 1.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_48(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(2.0, 14.0, 2.0), vec3(14.0, 16.0, 14.0), vec4(2.0, 0.0, 14.0, 2.0), 0, vec4(2.0, 2.0, 14.0, 14.0), 0, vec4(2.0, 0.0, 14.0, 2.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
    ...
    bool cube5 = cuboid(faces, rd, ro, vec3(2.0, 0.0, 2.0), vec3(14.0, 2.0, 14.0), vec4(2.0, 14.0, 14.0, 16.0), 0, vec4(2.0, 2.0, 14.0, 14.0), 0, vec4(2.0, 14.0, 14.0, 16.0), 0, uvRange, t, col);
    if (cube5 && t < minT) {
        minT = t;
        outCol = col;
    }
    bool cube6 = cuboid(faces, rd, ro, vec3(2.0, 2.0, 2.0), vec3(14.0, 14.0, 14.0), vec4(2.0, 2.0, 14.0, 14.0), 0, vec4(2.0, 2.0, 14.0, 14.0), 0, vec4(2.0, 2.0, 14.0, 14.0), 0, uvRange, t, col);
    if (cube6 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_50(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(0.0, 0.0, 0.0), vec3(16.0, 3.0, 16.0), vec4(0.0, 16.0, 16.0, 13.0), 0, vec4(0.0, 0.0, 16.0, 16.0), 0, vec4(0.0, 16.0, 16.0, 13.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_57(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(6.0, 12.0, 6.0), vec3(10.0, 16.0, 10.0), vec4(0.0, 0.0, 4.0, 4.0), 0, vec4(4.0, 4.0, 0.0, 0.0), 0, vec4(0.0, 0.0, 4.0, 4.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
    bool cube1 = cuboid(faces, rd, ro, vec3(7.0, 0.0, 7.0), vec3(9.0, 12.0, 9.0), vec4(0.0, 4.0, 2.0, 16.0), 0, vec4(7.0, 7.0, 9.0, 9.0), 0, vec4(0.0, 4.0, 2.0, 16.0), 0, uvRange, t, col);
    if (cube1 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_58(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(1.0, 15.9, 1.0), vec3(15.0, 15.9, 15.0), vec4(1.0, 0.09999999999999964, 15.0, 0.09999999999999964), 0, vec4(1.0, 1.0, 15.0, 15.0), 0, vec4(1.0, 0.09999999999999964, 15.0, 0.09999999999999964), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_60(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(0.0, 0.0, 0.0), vec3(16.0, 3.0, 16.0), vec4(0.0, 0.0, 16.0, 3.0), 0, vec4(0.0, 16.0, 16.0, 0.0), 0, vec4(0.0, 0.0, 16.0, 3.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_67(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(8.0, 2.99, 8.0), vec3(15.0, 2.99, 15.0), vec4(1.0, 13.01, 8.0, 13.01), 0, vec4(8.0, 8.0, 0.0, 0.0), 0, vec4(1.0, 13.01, 8.0, 13.01), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
    bool cube1 = cuboid(faces, rd, ro, vec3(1.0, 8.0, 1.0), vec3(8.0, 8.0, 8.0), vec4(8.0, 8.0, 15.0, 8.0), 0, vec4(0.0, 0.0, 8.0, 8.0), 0, vec4(8.0, 8.0, 15.0, 8.0), 0, uvRange, t, col);
    if (cube1 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_71(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(0.0, 0.0, 0.0), vec3(16.0, 12.0, 16.0), vec4(0.0, 4.0, 16.0, 16.0), 0, vec4(0.0, 0.0, 16.0, 16.0), 0, vec4(0.0, 4.0, 16.0, 16.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_72(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(0.0, 0.0, 0.0), vec3(16.0, 13.0, 16.0), vec4(0.0, 3.0, 16.0, 16.0), 0, vec4(0.0, 0.0, 16.0, 16.0), 0, vec4(0.0, 3.0, 16.0, 16.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_73(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(0.0, 0.0, 0.0), vec3(16.0, 6.0, 16.0), vec4(0.0, 10.0, 16.0, 16.0), 0, vec4(0.0, 0.0, 16.0, 16.0), 0, vec4(0.0, 10.0, 16.0, 16.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool block_74(int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    ...
    float t;
    vec4 col;
    bool cube0 = cuboid(faces, rd, ro, vec3(1.0, 0.0, 1.0), vec3(15.0, 1.0, 15.0), vec4(1.0, 15.0, 15.0, 16.0), 0, vec4(1.0, 1.0, 15.0, 15.0), 0, vec4(1.0, 15.0, 15.0, 16.0), 0, uvRange, t, col);
    if (cube0 && t < minT) {
        minT = t;
        outCol = col;
    }
...
bool custom_block(int modelID, int faces, vec3 rd, vec3 ro, out vec4 outCol) {
    switch (modelID) {
        ...
        case 2:
            return block_2(faces, rd, ro, outCol);
        case 3:
            return block_3(faces, rd, ro, outCol);
        case 4:
            return block_4(faces, rd, ro, outCol);
        case 5:
            return block_5(faces, rd, ro, outCol);
        case 6:
            return block_6(faces, rd, ro, outCol);
        case 7:
            return block_7(faces, rd, ro, outCol);
        case 8:
            return block_8(faces, rd, ro, outCol);
        case 9:
            return block_9(faces, rd, ro, outCol);
        case 10:
            return block_10(faces, rd, ro, outCol);
        case 11:
            return block_11(faces, rd, ro, outCol);
        case 12:
            return block_12(faces, rd, ro, outCol);
        case 13:
            return block_13(faces, rd, ro, outCol);
        case 14:
            return block_14(faces, rd, ro, outCol);
        case 15:
            return block_15(faces, rd, ro, outCol);
        case 16:
            return block_16(faces, rd, ro, outCol);
        case 17:
            return block_17(faces, rd, ro, outCol);
        case 18:
            return block_18(faces, rd, ro, outCol);
        case 19:
            return block_19(faces, rd, ro, outCol);
        case 20:
            return block_20(faces, rd, ro, outCol);
        case 21:
            return block_21(faces, rd, ro, outCol);
        case 22:
            return block_22(faces, rd, ro, outCol);
        case 23:
            return block_23(faces, rd, ro, outCol);
        case 24:
            return block_24(faces, rd, ro, outCol);
        case 25:
            return block_25(faces, rd, ro, outCol);
        case 26:
            return block_26(faces, rd, ro, outCol);
        case 27:
            return block_27(faces, rd, ro, outCol);
        case 28:
            return block_28(faces, rd, ro, outCol);
        case 29:
            return block_29(faces, rd, ro, outCol);
        case 30:
            return block_30(faces, rd, ro, outCol);
        case 31:
            return block_31(faces, rd, ro, outCol);
        case 32:
            return block_32(faces, rd, ro, outCol);
        case 33:
            return block_33(faces, rd, ro, outCol);
        case 34:
            return block_34(faces, rd, ro, outCol);
        case 35:
            return block_35(faces, rd, ro, outCol);
        case 36:
            return block_36(faces, rd, ro, outCol);
        case 37:
            return block_37(faces, rd, ro, outCol);
        case 38:
            return block_38(faces, rd, ro, outCol);
        case 39:
            return block_39(faces, rd, ro, outCol);
        case 40:
            return block_40(faces, rd, ro, outCol);
        case 41:
            return block_41(faces, rd, ro, outCol);
        case 42:
            return block_42(faces, rd, ro, outCol);
        case 43:
            return block_43(faces, rd, ro, outCol);
        case 44:
            return block_44(faces, rd, ro, outCol);
        case 45:
            return block_45(faces, rd, ro, outCol);
        case 46:
            return block_46(faces, rd, ro, outCol);
        case 47:
            return block_47(faces, rd, ro, outCol);
        case 48:
            return block_48(faces, rd, ro, outCol);
        case 49:
            return block_49(faces, rd, ro, outCol);
        case 50:
...
void main() {
    if (modelID != -1) {
        ...
        if (custom_block(modelID, faces, rd, ro, fragColor)) return;
        else discard;
    }
