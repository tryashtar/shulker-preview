...
execute if score #ready shulker_preview matches 1 if score #ender_chests shulker_preview matches 1.. run function tryashtar.shulker_preview:ender_chest/prepare
