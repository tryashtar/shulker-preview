...
execute if data storage tryashtar.shulker_preview:data item{id:"minecraft:ice"} run summon marker ~ ~ ~ {Tags:["tryashtar.shulker_preview"],CustomName:'{"translate":"tryashtar.shulker_preview.block.ice.1","color":"#0007fc"}'}
...
execute if data storage tryashtar.shulker_preview:data item{id:"minecraft:mud"} run summon marker ~ ~ ~ {Tags:["tryashtar.shulker_preview"],CustomName:'{"translate":"tryashtar.shulker_preview.block.mud.1","color":"#0007fc"}'}
