...
def main(ctx: beet.Context):
   ...
   ctx.data.icon = icon
   ctx.assets.pack_format = 64 # 1.21.7
   ctx.assets.supported_formats = [64, 64] # 1.21.7
   ...
   ctx.data.pack_format = 81 # 1.21.7
   ctx.data.supported_formats = [81, 81] # 1.21.7
