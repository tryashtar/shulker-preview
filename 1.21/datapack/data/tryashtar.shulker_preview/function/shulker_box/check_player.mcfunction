...
execute store result score #boxes shulker_preview run clear @s #tryashtar.shulker_preview:shulker_boxes[!custom_data~{"shulker_preview.processed":1b},container~{}] 0
