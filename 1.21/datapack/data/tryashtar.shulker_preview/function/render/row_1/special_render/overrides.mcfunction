...
execute if items entity @s contents test_block run return run function tryashtar.shulker_preview:render/row_1/special_render/test_block with storage tryashtar.shulker_preview:data item
