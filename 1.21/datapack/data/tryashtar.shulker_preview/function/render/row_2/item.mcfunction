...
execute if items entity @s contents #tryashtar.shulker_preview:special_render run function tryashtar.shulker_preview:render/row_2/special with storage tryashtar.shulker_preview:data item
execute unless items entity @s contents #tryashtar.shulker_preview:special_render run function tryashtar.shulker_preview:render/row_2/simple with storage tryashtar.shulker_preview:data item
...
execute if items entity @s contents *[bundle_contents~{items:{size:{min:1}}}] run function tryashtar.shulker_preview:render/row_2/overlay/bundle_bar
