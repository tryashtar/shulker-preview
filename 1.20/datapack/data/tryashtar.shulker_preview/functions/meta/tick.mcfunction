...
execute if score #shulker_enabled shulker_preview matches 1 as @e[type=item,tag=!shulker_preview.checked] at @s run function tryashtar.shulker_preview:check_dropped
