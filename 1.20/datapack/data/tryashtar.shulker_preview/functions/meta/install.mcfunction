...
tellraw @a [{"text":"\nSuccessfully installed ","color":"#8fdff7"},{"text":"tryashtar's","color":"#468beb","hoverEvent":{"action":"show_text","contents":{"text":"(click to see more of my stuff)","color":"gray"}},"clickEvent":{"action":"open_url","value":"https://youtube.com/c/tryashtar"}},{"text":" Shulker Preview Pack!\nThank you and enjoy.","color":"#8fdff7"}]
