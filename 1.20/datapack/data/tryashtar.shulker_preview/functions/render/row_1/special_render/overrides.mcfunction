...
execute if items entity @s contents bundle run return run function tryashtar.shulker_preview:render/row_1/special_render/bundle with storage tryashtar.shulker_preview:data item
