...
execute if items entity @s contents #tryashtar.shulker_preview:special_render run function tryashtar.shulker_preview:render/row_0/special_render with storage tryashtar.shulker_preview:data item
execute unless items entity @s contents #tryashtar.shulker_preview:special_render run function tryashtar.shulker_preview:render/row_0/simple_render with storage tryashtar.shulker_preview:data item
...
execute if items entity @s contents bundle[bundle_contents~{items:{size:{min:1}}}] run function tryashtar.shulker_preview:render/row_0/overlay/bundle_bar
