...
execute if items entity @s weapon #banners if data storage tryashtar.shulker_preview:data item.components."minecraft:banner_patterns"[0] run function tryashtar.shulker_preview:row_1/overlay/banner_patterns
execute if items entity @s weapon shield if data storage tryashtar.shulker_preview:data item.components."minecraft:base_color" run function tryashtar.shulker_preview:row_1/overlay/shield_base
execute if items entity @s weapon shield if data storage tryashtar.shulker_preview:data item.components."minecraft:banner_patterns"[0] run function tryashtar.shulker_preview:row_1/overlay/shield_patterns
...
execute if items entity @s weapon bundle[bundle_contents~{items:{size:{min:1}}}] run function tryashtar.shulker_preview:row_1/overlay/bundle_bar
