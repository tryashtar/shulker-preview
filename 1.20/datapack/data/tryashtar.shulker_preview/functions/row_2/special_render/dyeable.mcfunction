...
$execute if items entity 7368756c-6b65-7220-7072-657669657721 contents wolf_armor run data modify storage tryashtar.shulker_preview:data tooltip append value '[{"translate":"tryashtar.shulker_preview.layer.$(id).0.2"},{"translate":"tryashtar.shulker_preview.layer.$(id).1.2","color":"#00aced"}]'
$execute unless items entity 7368756c-6b65-7220-7072-657669657721 contents wolf_armor run data modify storage tryashtar.shulker_preview:data tooltip append value '[{"translate":"tryashtar.shulker_preview.layer.$(id).0.2","color":"#00aced"},{"translate":"tryashtar.shulker_preview.layer.$(id).1.2","color":"white"}]'
