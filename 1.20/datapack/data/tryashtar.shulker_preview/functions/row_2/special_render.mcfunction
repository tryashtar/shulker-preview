...
execute if items entity @s weapon #tryashtar.shulker_preview:special_render/potion run return run function tryashtar.shulker_preview:row_2/special_render/potion1
execute if items entity @s weapon firework_star run return run function tryashtar.shulker_preview:row_2/special_render/star1
execute if items entity @s weapon filled_map run return run function tryashtar.shulker_preview:row_2/special_render/map1
