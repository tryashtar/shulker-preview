...
execute if data storage tryashtar.shulker_preview:data item{id:"minecraft:ice"} run summon marker ~ ~ ~ {Tags:["tryashtar.shulker_preview"],CustomName:'{"translate":"tryashtar.shulker_preview.block.ice.2"}'}
...
execute if data storage tryashtar.shulker_preview:data item{id:"minecraft:mud"} run summon marker ~ ~ ~ {Tags:["tryashtar.shulker_preview"],CustomName:'{"translate":"tryashtar.shulker_preview.block.mud.2"}'}
execute if data storage tryashtar.shulker_preview:data item{id:"minecraft:tnt"} run summon marker ~ ~ ~ {Tags:["tryashtar.shulker_preview"],CustomName:'{"translate":"tryashtar.shulker_preview.block.tnt.2"}'}
