...
def main(ctx: beet.Context):
   ...
   ctx.data.icon = icon
   ctx.assets.pack_format = 18 # 1.20.2
   ctx.assets.supported_formats = [15, 18] # 1.20 - 1.20.2
   ...
   ctx.data.pack_format = 18 # 1.20.2
   ctx.data.supported_formats = [15, 18] # 1.20 - 1.20.2
